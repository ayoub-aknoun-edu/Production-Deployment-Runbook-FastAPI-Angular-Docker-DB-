...
```nginx
# larger bodies & generous timeouts for video/media workflows
client_max_body_size 50m;
proxy_read_timeout 600s;
proxy_send_timeout 600s;

# serve generated files directly (faster than passing to app)
location ^~ /assets/ {
    alias /home/SITE_USER_BACK/htdocs/API_DOMAIN/backend/assets/;
    expires 30d;
